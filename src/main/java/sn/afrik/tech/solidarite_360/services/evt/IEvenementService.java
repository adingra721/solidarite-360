...
public interface IEvenementService  {
     ...
     * @return persisted entity Evenement
     */
    Evenement create(Evenement d);
     ...
     * @return Evenement
     */
    Evenement update(Evenement d);

    /**
     * get Evenement by id. Can be return empty
     *
     * @param id the id of the entity.
     * @return Evenement
     */
    Evenement getOne(Long id) ;

    /**
     * Get all entities
     *
     * @return list of entities List<Evenement>
     */
     ...
     * @return Page<Evenement>  
     */
	Page<Evenement> findAllSpecification(Specification<Evenement> specs, Pageable pageable);
